...
// Sección I2C
 ...
 // Para Nano/Pro Mini (Usando PB1 y PB2)
 #define SDA 1
 #define SCL 2
 #define PORT_I2C PORTB
 #define DDR_I2C  DDRB
...
#if RetardoI2C!=0
#define SDA_ALTO() PORT_I2C|=(1<<SDA);  __builtin_avr_delay_cycles((RetardoI2C*F_CPU)/1000000UL)
#define SDA_BAJO() PORT_I2C&=~(1<<SDA); __builtin_avr_delay_cycles((RetardoI2C*F_CPU)/1000000UL)
#define SCL_ALTO() PORT_I2C|=(1<<SCL);  __builtin_avr_delay_cycles((RetardoI2C*F_CPU)/1000000UL)
#define SCL_BAJO() PORT_I2C&=~(1<<SCL); __builtin_avr_delay_cycles((RetardoI2C*F_CPU)/1000000UL)
#else
